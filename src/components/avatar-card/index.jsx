        ...
        <div className="text-center mx-auto px-8">
          ...
          <div className="mt-3 text-base-content text-opacity-60 font-mono" align="justify">
            {/* {loading || !profile
              ...
              : bio} */}
              Greetings from Nam Le Hai! I completed the Master of Data Science at Hanoi University of Science and Technology. At present, I am engaged in research as an AI resident at FPT Software AIC Lab, working under the guidance of <span color="blue" ><a href="https://bdqnghi.github.io/">Dr. Nghi Bui</a></span>, and my primary focus is on AI4Code. Looking to the future, I am excited about the possibility of pursuing a Ph.D. in 2024, with a strong desire to delve further into research in the field of AI4Code or Natural Language Processing.
          </div>
        </div>
        {resume?.fileUrl &&
          (loading ? (
