...
const Hero = () => (
  ...
  >
    <div className="w-28 h-28 sm:w-32 sm:h-32 shrink-0 rounded-full bg-accent/10 dark:bg-[#7fa8d9]/15 border border-accent/20 dark:border-[#7fa8d9]/30 grid place-items-center">
